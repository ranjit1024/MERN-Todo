...
export function SignIn(){
  ...
  <div className="w-[90%] flex  text-start mt-4">
    ...
    <label className="block mb-1 ml-1 text-sm  text-slate-900 font-poppins font-medium">
      ...
      <input type={pstatus ? 'text' : 'password'} className="w-full pl-3 pr-3 py-2 bg-gray-100 placeholder:text-slate-400 text-slate-600 text-sm border border-slate-200 rounded-md transition duration-300 ease focus:outline-none focus:border-blue-400 hover:border-blue-300 shadow-sm focus:shadow" placeholder="Your password" />
