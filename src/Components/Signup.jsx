...
<div className="login flex-col bg-gradient-to-tl to-green-200 from-blue-200 flex justify-center items-center text-center h-[100%] w-[100%]">
  ...
  <label className="block mb-1  text-sm  text-slate-900 font-poppins font-medium" htmlFor="firstname" >
      First Name
  </label>
  <input className="w-full bg-gray-100 placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-blue-400 hover:border-blue-300 shadow-sm focus:shadow font-poppins" placeholder="fisrst Name" id="firstname" />
</div> <div className="w-[90%] flex flex-col justify-start items-start text-center">
  <label className="block mb-1 ml-1 text-sm font-poppins  text-slate-900 font-medium">
      Last Name
  </label>
  <input className="w-full bg-gray-100 placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-blue-400 hover:border-blue-300 font-poppins shadow-sm focus:shadow" placeholder="Last name" />
</div>
    </div>
